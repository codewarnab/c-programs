...
void dtob()
{
    ...
    int n, i = 0, arr[100], arr1[100], rem;
    float num, n2;
...
void btod()
{
    ...
    while (n != 0)
    {   // this logic revserses the array so numberarray will be assigned in revserse order so if user enters 1010 it will be [0,1,0,1]
        numberArray[c] = n % 10; 
        n /= 10;
        c++;
    }
